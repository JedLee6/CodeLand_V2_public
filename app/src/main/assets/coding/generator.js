...
Blockly.JavaScript.lists_repeat = function(a) {
	var b = Blockly.JavaScript.provideFunction_("listsRepeat", ["function " + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + "(value, n) {",
	"  var array = [];",
	"  for (var i = 0; i < n; i++) {",
	"   if(value instanceof Array){",
	"       var valuetemp=[];",
	"       for(var item in value){",
	"           valuetemp[item]=value[item];",
	"       }",
	"   }else{",
	"       valuetemp=value;",
	"   }",
...
//Blockly.JavaScript.procedures_defreturn_mutator = function(a) {
...
Blockly.JavaScript.procedures_defreturn_mutator=Blockly.JavaScript.procedures_defreturn;
